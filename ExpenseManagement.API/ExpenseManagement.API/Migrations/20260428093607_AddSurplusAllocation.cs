...
{
    /// <inheritdoc />
    public partial class AddSurplusAllocation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurplusAllocations_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SurplusAllocations_SavingsGoals_SavingsGoalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurplusAllocations_SavingsGoalId",
                table: "SurplusAllocations",
                column: "SavingsGoalId");

            migrationBuilder.CreateIndex(
                name: "IX_SurplusAllocations_UserId",
                table: "SurplusAllocations",
                column: "UserId");
        }
